...
Route::group(['middlewareGroups' => 'web'], function () {
    ...
    Route::get('/book-table', 'ManageTableController@FrontTable');
    Route::post('/table_ajax_book_front', 'ManageTableController@SetBookTable');
...
Route::group(
    ['middleware' => 'auth'], function () {
        ...
        Route::get('/table_booking', 'ManageTableController@getBookTables');
        Route::post('/table_ajax_book', 'ManageTableController@SetBookTable');
